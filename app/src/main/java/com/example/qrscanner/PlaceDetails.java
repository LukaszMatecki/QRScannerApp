...
public class PlaceDetails extends AppCompatActivity {
    ...
    private void updateIcons() {
        iconFavorite.setImageResource(isFavorite ? R.drawable.favorite_color_icon : R.drawable.favorite_icon);
        iconVisited.setImageResource(isVisited ? R.drawable.checkpositive_color_icon : R.drawable.checkpositive_icon);
    }
